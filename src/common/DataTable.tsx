...
import { Table, TableContainer, TableHead, TableRow, TableCell, TableSortLabel, TableBody } from '@mui/material';
...
export function DataTable() {
    ...
    let emptyRows = 5;
    return (<TableContainer sx={{ maxWidth: 300, minWidth: 0, height: '100%' }}>
        <Table
                    ...
                    .map((row, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <TableCell
                                    sx={{ overflow: 'clip', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: 130 }}
                                    component="th"
                                    id={labelId}
                                    scope="row"
                                    padding="none"
